...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Roboto, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#656464'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '36px', 'lineheight' => '38px', 'face' => 'Roboto Condensed', 'style' => 'normal', 'character'  => 'latin', 'color' => '#FFFFFF'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '36px', 'lineheight' => '44px', 'face' => 'Roboto Condensed', 'style' => 'normal', 'character'  => 'latin', 'color' => '#FFFFFF'));

			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '14px', 'lineheight' => '20px', 'face' => 'Roboto, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#d9985f'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '48px', 'lineheight' => '48px', 'face' => 'Roboto Condensed', 'style' => 'normal', 'character'  => 'latin', 'color' => '#FFFFFF'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '14px', 'lineheight' => '18px', 'face' => 'Roboto Condensed', 'style' => 'normal', 'character'  => 'latin', 'color' => '#FFFFFF'));
...
// ---------------------------------------------------------
        ...
        // ---------------------------------------------------------
           ...
           $options["header_content"] = array( "name" => __('Header Content', CURRENT_THEME),
                "type" => "heading");
        
           $options['page_slug'] = array( "name" => __('Enter page slug', CURRENT_THEME),
                "desc" => __('Enter the slug of the page that will be used by content', CURRENT_THEME),
                "id" => "page_slug",
                "std" => "header-content",
                "type" => "text");
            ...
            //Address
            	$options[] = array( 
            						"name" => __('Address', CURRENT_THEME),
            						"type" => "heading"
            	);
            	
            	$options['address'] = array( 
            						"name" => __('Address', CURRENT_THEME),
            						"desc" => __('Address. HTML tags are allowed.', CURRENT_THEME),
            						"id" => "address",
            						"std" => "<span>Get free legal consultation:</span><strong>(800) 123 1234</strong><em>7 days a week<br>from 8:00 am to 2:00 am</em>",
            						"type" => "textarea"
            	);
